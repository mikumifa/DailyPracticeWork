...
f2 = Flight("BCS101", Airport("ABQ", "Albuquerque", "United States", "North America"),
            Airport("OMA", "Omaha", "United States", "North America"))
f3 = Flight("XYZ321", a1, a2)
t1 = f1.getFlightNumber() == "ABC123" and f1.getOrigin() == a1 and f1.getDestination() == a2
t2 = f1 != f2 and f1 == f3
t3 = equals("Flight(ABC123): London -> Athens [international]", f1.__repr__()) and equals(
    "Flight(BCS101): Albuquerque -> Omaha [domestic]", f2.__repr__())
...
if res == {'XJX595', 'LJC201', 'DAJ762', 'MDW532', 'YZF667', 'JAG578', 'JKQ130', 'JHW048', 'YFZ738', 'CUN974', 'NIA196',
           'VKG041', 'VIP930', 'YOF338', 'USO770', 'USO771'}:
...
if res == {'MTN376', 'QMG091', 'VDT680', 'CSY487', 'YOI104', 'TYV528', 'KPP582', 'CSX772', 'ERO171', 'PGY075', 'YVF322',
           'EYS649'}:
